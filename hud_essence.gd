...
func _physics_process(delta: float) -> void:
	...
	if Input.is_action_just_pressed("attack2"):
		if Global.fire:
			$AnimationPlayer.play("firecooldown")		
		elif Global.water:
			$AnimationPlayer.play("watercooldown")
		elif Global.earth:	
			$AnimationPlayer.play("earthcooldown")
#	if Global.firecooldownanim == true:
#		$AnimationPlayer.play("firecooldown")
#		Global.firecooldownanim == false
		
#	elif Global.watercooldownanim == true:
#		$AnimationPlayer.play("watercooldown")
#		Global.watercooldownanim == false
	
#	elif Global.earthcooldownanim == true:
#		$AnimationPlayer.play("earthcooldown")
#		Global.earthcooldownanim == false
